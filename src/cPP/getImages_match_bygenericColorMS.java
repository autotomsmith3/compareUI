...
// This is for CPP-2290 MS endpoint: http://lnoc-q1cp-xmw1:8080/model-image-color-service/images/match_by/genericColor
// Copied from  Images_getColorImages_GvuidsMS_CPP-889. Initial on April 09, 2018 with basic 13 items 
// but it maybe contain more like secondary color and so on...Now it contains 18 items that match SP and Images_getColorImages_GvuidsMS_CPP-889.
...
public class getImages_match_bygenericColorMS {
	...
	public static void getColorImage_GvuidsMS() throws Exception {
		...
		String[] SpiraID = { "TC193461", "TC193462", "TC193463", "TC193464" };

		// "TC193465", "TC193466", "TC193467",
		...
		// "TC193492", "TC193493", "TC193494", "TC193495", "TC193496", "TC193497", "TC193498", "TC193499" };
		...
		for (int k = startToRun; k <= endToRun; k++) {// vintotal; k++) {
			...
			String getColorImage_GvuidsMSSavePathFile = "C:\\1\\Eclipse\\Test Results\\CompareMS\\Images_match_bygenericColor_CPP-2290\\"
					+ dateFolder + "\\images_" + kStr + ".xls";
			String jsonpathfilename = "C:\\1\\Eclipse\\Test Results\\CompareMS\\Images_match_bygenericColor_CPP-2290\\"
					+ dateFolder + "\\image";// + ".json";

			String[] titleStringgetImageWS = { "S/N", "URL_parameter", "RequestBody", "serverTime", "serverTimeString",
					"serverName", "executionTimeMS", "resultObj", "error", "currentGVUID", "gvuidObj", "gvuid",
					"imageName", "colorId", "primaryColorCode", "primaryColorDesc", "genericColor",
					"secondaryColorCode", "secondaryColorDesc", "accentColorCode", "accentColorDesc", "optionCode",
					"shotDescription", "rangeDescription", "groupDescription", "shotId", "rangeId", "groupId",
					"imageView" };
			//// // DEV PUT
			// String imagePutServiceURL = "http://lnoc-dvcp-xmw1:8080/model-image-color-service/images/match_by/genericColor";

			// // QA PUT
			String imagePutServiceURL = "http://lnoc-q1cp-xmw1:8080/model-image-color-service/images/match_by/genericColor";
			...
			for (int i = 0; i < datasize - 1; i++) {
				...
				String bodyDatafile = "C:\\1\\Eclipse\\Test Results\\CompareMS\\Images_match_bygenericColor_CPP-2290\\TestData\\imageBodyData_"
			...
			try {
				...
				if (size == 0) {
					...
					while (keys.hasNext()) {
						...
						currentGVUID = currentDynamicKey;
						keysCount++;
						gvuidObj = Integer.toString(keysCount);
						...
						if (gvuidSize == 0) {
							...
							jsonValue[8] = error;
							jsonValue[9] = currentGVUID;

							jsonValue[10] = gvuidObj;
						...
						for (int i = 0; i < gvuidSize; i++) {
							...
							jsonValue[10] = gvuidObj;
							jsonValue[11] = gvuid;
							jsonValue[12] = imageName;
							jsonValue[13] = colorId;
							jsonValue[14] = primaryColorCode;
							jsonValue[15] = primaryColorDesc;
							jsonValue[16] = genericColor;
							jsonValue[17] = secondaryColorCode;
							jsonValue[18] = secondaryColorDesc;
							jsonValue[19] = accentColorCode;
							jsonValue[20] = accentColorDesc;
