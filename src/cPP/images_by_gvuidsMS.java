...
public class images_by_gvuidsMS {
	private static int blank = 0;
	private static int noObj = 0;

	public static void getImages_By_GvuidsMS() throws Exception {
		...
		for (int k = startToRun; k <= endToRun; k++) {// vintotal; k++) {
			...
			String getImages_By_GvuidsMSSavePathFile = "C:\\1\\Eclipse\\Test Results\\CompareMS\\Images_By_GvuidsMS_CPP-889\\"
			...
			for (int i = 0; i < datasize - 1; i++) {
				...
				getImages_By_GvuidsMSDetails(getImages_By_GvuidsMSSavePathFile, titleStringgetImageWS,
						jsonTextFrgetImageWS, imagePutServiceURL, imageMSBodyParameters[i], count);
			}
		}
	}

	public static void getImages_By_GvuidsMSDetails(String wsResultfile, String[] titleString, String text,
