...
public class AdminPortalLogin extends Comlibs {
	private final WebDriver driver;

	public AdminPortalLogin(WebDriver driver) throws IOException {
		this.driver = driver;
	...
	public AdminPortalLogin inputUername(WebDriver driver, String un) {
		driver.findElement(usernameLocator).clear();
		driver.findElement(usernameLocator).sendKeys(un);
		return this;
	}

	public AdminPortalLogin inputPassword(WebDriver driver, String ps) {
