//Updated for AUTOPXOPS-789 ON June 21, 2018. Works fine!
//
...
public class getSyndicationWS_dealer_guid {
	...
	public static void syndicationWSCompleteImageList(String wsResultfile, String[] titleSyndicationWS, String text,
			String dealer_guid) throws IOException {
		JSONObject obj = new JSONObject(text);
		...
		for (int i = 0; i < sizeArray; i++) {
			...
			try {
				publishDate = Double.toString(arr.getJSONObject(i).getDouble("publishDate"));
			} catch (Exception ex) {
				publishDate = "null";
			}
...
//					+ sequence + ", imgGroup:" + imgGroup);
	...
	public static void jSonObjec_SydicationWS() throws IOException {
		String sydicationWSSavePathFile = "C:\\1\\Eclipse\\Test Results\\SyndicationWS\\SydicationWS_Return.xls";
		...
		// DealerID:111153, autotomsmith3@gmail.com: "B9C7B860-3578-4F5A-8A8B-86A697F65C4E"
		// DealerID: 123456, lucas.zhou@autodata.net, FEB6AE7C-4DDC-42CD-9F61-A1BDE81AF204
		String dealer_guid = "FEB6AE7C-4DDC-42CD-9F61-A1BDE81AF204";//123456
//		String dealer_guid = "B9C7B860-3578-4F5A-8A8B-86A697F65C4E";//111153
		
		// ************QA**********:
		// // ************Prod********:
		// String env = "http://syndication.vinpx.net/SyndicationWebServices/";
		// String dealer_guid = "666666";
		// // ************Prod********:
		String sydicationWSCompleteImageListURL = env + dealer_guid + "/CompleteImageList";
		...
		// syndicationWSCompleteImageList(sydicationWSsavePathFile, titleStringSydicationWS, jsonTextFrSydicationWS, dealer_guid);
