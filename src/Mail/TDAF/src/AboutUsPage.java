...
public class AboutUsPage extends ZljLibrary{
	private final WebDriver driver;
//	public AboutUsPage(WebDriver driver) throws IOException{
//		this.driver=driver;
//	   	if (!"TD Auto Finance - About Us".equals(driver.getTitle()))
//	   	{
//	   		rwExcel(false, "Try to load About Us page", "But page title is not the TD Auto Finance - About Us"); 
//		 throw new IllegalStateException("This is not the TD Auto Finance - About Us");
//	   	}
//	}
	public AboutUsPage(WebDriver driver) throws IOException{
		this.driver=driver;
		String sPageTitle="TD Auto Finance - About Us";
